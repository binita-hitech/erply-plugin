...
import { ArrowDropDownOutlined, ArrowDropUpOutlined, ArrowUpward } from "@mui/icons-material";
import {
  Accordion,
  AccordionDetails,
  Box,
    ...
    <>
      ...
      <DetailsDiv>
        ...
        >
          ...
          <span style={{ display: 'flex', alignItems: 'center', marginLeft: "35%", paddingBottom: "10px" }} onClick={toggleAccordion}>
            {isAccordionOpen ? 'Show Less' : 'Show More'}
            {isAccordionOpen ? <ArrowDropUpOutlined /> : <ArrowDropDownOutlined />}
          </span>
